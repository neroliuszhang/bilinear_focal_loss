...
if __name__ == '__main__':
    ...
    val_data = h5py.File('/home/goerlab/Bilinear-CNN-TensorFlow/train_test_small/new_val_224.h5', 'r')
    ...
    batch_size = 4  ######queenie edited:origin=32
    ...
    lr = 1.0
    base_lr = 1.0
    break_training_epoch = 3
    #for epoch in range(100):
    for epoch in range(4):   ###queenie edited, origin is as above#############
        ...
        if epoch==break_training_epoch:
            ...
            np.savez('last_layers_epoch_4.npz',last_layer_weights)
            print("Last layer weights saved")
            break

        avg_cost = 0.
        #total_batch = int(6000/batch_size)
        total_batch=int(333/batch_size) ####queenie edited, origin is as above###
        X_train, Y_train = shuffle(X_train, Y_train)
